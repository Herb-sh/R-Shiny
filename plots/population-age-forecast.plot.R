...
populationAgeForecast <- function (InputColumn){
  ...
  if (InputColumn == 'Fertility Rate'){
     plot_tilte='FORECAST: Zahl der Geburten pro 1.000 Frauen.'
    ...
    plot_tilte='FORECAST: Differenz zwischen Ein- und Auswanderer pro Jahr.'
  }else if (InputColumn == "Population") {
    plot_tilte='FORECAST: Gesamtbevölkerung (Million)'
  }
